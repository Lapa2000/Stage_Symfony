...
class FactureClientNewDataControllerTest extends WebTestCase
{
    private KernelBrowser $client;
    private EntityManagerInterface $manager;
    private EntityRepository $repository;
    private string $path = '/facture/client/new/data/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->manager = static::getContainer()->get('doctrine')->getManager();
        $this->repository = $this->manager->getRepository(FactureClientNewData::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('FactureClientNewDatum index');
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'facture_client_new_datum[code]' => 'Testing',
            'facture_client_new_datum[codedevis]' => 'Testing',
            'facture_client_new_datum[masociete]' => 'Testing',
            'facture_client_new_datum[monadresse]' => 'Testing',
            'facture_client_new_datum[montel]' => 'Testing',
            'facture_client_new_datum[monfax]' => 'Testing',
            'facture_client_new_datum[monregistre]' => 'Testing',
            'facture_client_new_datum[monmatricule]' => 'Testing',
            'facture_client_new_datum[clientcode]' => 'Testing',
            'facture_client_new_datum[clientraison]' => 'Testing',
            'facture_client_new_datum[clientnom]' => 'Testing',
            'facture_client_new_datum[clientprenom]' => 'Testing',
            'facture_client_new_datum[clienttel]' => 'Testing',
            'facture_client_new_datum[clientfax]' => 'Testing',
            'facture_client_new_datum[clientadresse]' => 'Testing',
            'facture_client_new_datum[clientmatricule]' => 'Testing',
            'facture_client_new_datum[totalht]' => 'Testing',
            'facture_client_new_datum[totaltva]' => 'Testing',
            'facture_client_new_datum[remises]' => 'Testing',
            'facture_client_new_datum[timbres]' => 'Testing',
            'facture_client_new_datum[totalttc]' => 'Testing',
            'facture_client_new_datum[chauffeurnom]' => 'Testing',
            'facture_client_new_datum[chauffeurvehicule]' => 'Testing',
            'facture_client_new_datum[creationcode]' => 'Testing',
            'facture_client_new_datum[creationnom]' => 'Testing',
            'facture_client_new_datum[creationprenom]' => 'Testing',
            'facture_client_new_datum[creationdate]' => 'Testing',
            'facture_client_new_datum[creationheure]' => 'Testing',
        ]);
    ...
    {
        $this->markTestIncomplete();
        $fixture = new FactureClientNewData();
        ...
        self::assertResponseStatusCodeSame(200);
        self::assertPageTitleContains('FactureClientNewDatum');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'facture_client_new_datum[code]' => 'Something New',
            'facture_client_new_datum[codedevis]' => 'Something New',
            'facture_client_new_datum[masociete]' => 'Something New',
            'facture_client_new_datum[monadresse]' => 'Something New',
            'facture_client_new_datum[montel]' => 'Something New',
            'facture_client_new_datum[monfax]' => 'Something New',
            'facture_client_new_datum[monregistre]' => 'Something New',
            'facture_client_new_datum[monmatricule]' => 'Something New',
            'facture_client_new_datum[clientcode]' => 'Something New',
            'facture_client_new_datum[clientraison]' => 'Something New',
            'facture_client_new_datum[clientnom]' => 'Something New',
            'facture_client_new_datum[clientprenom]' => 'Something New',
            'facture_client_new_datum[clienttel]' => 'Something New',
            'facture_client_new_datum[clientfax]' => 'Something New',
            'facture_client_new_datum[clientadresse]' => 'Something New',
            'facture_client_new_datum[clientmatricule]' => 'Something New',
            'facture_client_new_datum[totalht]' => 'Something New',
            'facture_client_new_datum[totaltva]' => 'Something New',
            'facture_client_new_datum[remises]' => 'Something New',
            'facture_client_new_datum[timbres]' => 'Something New',
            'facture_client_new_datum[totalttc]' => 'Something New',
            'facture_client_new_datum[chauffeurnom]' => 'Something New',
            'facture_client_new_datum[chauffeurvehicule]' => 'Something New',
            'facture_client_new_datum[creationcode]' => 'Something New',
            'facture_client_new_datum[creationnom]' => 'Something New',
            'facture_client_new_datum[creationprenom]' => 'Something New',
            'facture_client_new_datum[creationdate]' => 'Something New',
            'facture_client_new_datum[creationheure]' => 'Something New',
        ]);

        self::assertResponseRedirects('/facture/client/new/data/');

...
class ErpFacturesClientNewControllerTest extends WebTestCase
{
    private KernelBrowser $client;
    private EntityManagerInterface $manager;
    private EntityRepository $repository;
    private string $path = '/erp/factures/client/new/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->manager = static::getContainer()->get('doctrine')->getManager();
        $this->repository = $this->manager->getRepository(ErpFacturesClientNew::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('ErpFacturesClientNew index');
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'erp_factures_client_new[code]' => 'Testing',
            'erp_factures_client_new[codedevis]' => 'Testing',
            'erp_factures_client_new[champ_demande_new]' => 'Testing',
            'erp_factures_client_new[masociete]' => 'Testing',
            'erp_factures_client_new[monadresse]' => 'Testing',
            'erp_factures_client_new[montel]' => 'Testing',
            'erp_factures_client_new[monfax]' => 'Testing',
            'erp_factures_client_new[monregistre]' => 'Testing',
            'erp_factures_client_new[monmatricule]' => 'Testing',
            'erp_factures_client_new[clientcode]' => 'Testing',
            'erp_factures_client_new[clientraison]' => 'Testing',
            'erp_factures_client_new[clientnom]' => 'Testing',
            'erp_factures_client_new[clientprenom]' => 'Testing',
            'erp_factures_client_new[clienttel]' => 'Testing',
            'erp_factures_client_new[clientfax]' => 'Testing',
            'erp_factures_client_new[clientadresse]' => 'Testing',
            'erp_factures_client_new[clientmatricule]' => 'Testing',
            'erp_factures_client_new[totalht]' => 'Testing',
            'erp_factures_client_new[tva]' => 'Testing',
            'erp_factures_client_new[totaltva]' => 'Testing',
            'erp_factures_client_new[remises]' => 'Testing',
            'erp_factures_client_new[timbres]' => 'Testing',
            'erp_factures_client_new[totalttc]' => 'Testing',
            'erp_factures_client_new[chauffeurnom]' => 'Testing',
            'erp_factures_client_new[chauffeurvehicule]' => 'Testing',
            'erp_factures_client_new[creationcode]' => 'Testing',
            'erp_factures_client_new[creationnom]' => 'Testing',
            'erp_factures_client_new[creationprenom]' => 'Testing',
            'erp_factures_client_new[creationdate]' => 'Testing',
            'erp_factures_client_new[creationheure]' => 'Testing',
            'erp_factures_client_new[modepaimement]' => 'Testing',
            'erp_factures_client_new[numbercompte]' => 'Testing',
            'erp_factures_client_new[montantsaisie]' => 'Testing',
            'erp_factures_client_new[accomptesaisie]' => 'Testing',
            'erp_factures_client_new[etatfacture]' => 'Testing',
        ]);
    ...
    {
        $this->markTestIncomplete();
        $fixture = new ErpFacturesClientNew();
        $fixture->setCode('My Title');
        $fixture->setCodedevis('My Title');
        $fixture->setChamp_demande_new('My Title');
        ...
        self::assertResponseStatusCodeSame(200);
        self::assertPageTitleContains('ErpFacturesClientNew');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setChamp_demande_new('Value');
        ...
        $this->client->submitForm('Update', [
            'erp_factures_client_new[code]' => 'Something New',
            'erp_factures_client_new[codedevis]' => 'Something New',
            'erp_factures_client_new[champ_demande_new]' => 'Something New',
            'erp_factures_client_new[masociete]' => 'Something New',
            'erp_factures_client_new[monadresse]' => 'Something New',
            'erp_factures_client_new[montel]' => 'Something New',
            'erp_factures_client_new[monfax]' => 'Something New',
            'erp_factures_client_new[monregistre]' => 'Something New',
            'erp_factures_client_new[monmatricule]' => 'Something New',
            'erp_factures_client_new[clientcode]' => 'Something New',
            'erp_factures_client_new[clientraison]' => 'Something New',
            'erp_factures_client_new[clientnom]' => 'Something New',
            'erp_factures_client_new[clientprenom]' => 'Something New',
            'erp_factures_client_new[clienttel]' => 'Something New',
            'erp_factures_client_new[clientfax]' => 'Something New',
            'erp_factures_client_new[clientadresse]' => 'Something New',
            'erp_factures_client_new[clientmatricule]' => 'Something New',
            'erp_factures_client_new[totalht]' => 'Something New',
            'erp_factures_client_new[tva]' => 'Something New',
            'erp_factures_client_new[totaltva]' => 'Something New',
            'erp_factures_client_new[remises]' => 'Something New',
            'erp_factures_client_new[timbres]' => 'Something New',
            'erp_factures_client_new[totalttc]' => 'Something New',
            'erp_factures_client_new[chauffeurnom]' => 'Something New',
            'erp_factures_client_new[chauffeurvehicule]' => 'Something New',
            'erp_factures_client_new[creationcode]' => 'Something New',
            'erp_factures_client_new[creationnom]' => 'Something New',
            'erp_factures_client_new[creationprenom]' => 'Something New',
            'erp_factures_client_new[creationdate]' => 'Something New',
            'erp_factures_client_new[creationheure]' => 'Something New',
            'erp_factures_client_new[modepaimement]' => 'Something New',
            'erp_factures_client_new[numbercompte]' => 'Something New',
            'erp_factures_client_new[montantsaisie]' => 'Something New',
            'erp_factures_client_new[accomptesaisie]' => 'Something New',
            'erp_factures_client_new[etatfacture]' => 'Something New',
        ]);

        self::assertResponseRedirects('/erp/factures/client/new/');

        $fixture = $this->repository->findAll();

        self::assertSame('Something New', $fixture[0]->getCode());
        self::assertSame('Something New', $fixture[0]->getCodedevis());
        self::assertSame('Something New', $fixture[0]->getChamp_demande_new());
